...
export default function AdminRecipientProfileScreen({ route }) {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.innercontainer}>
          ...
          <View style={styles.buttonsContainer}>
            <TouchableOpacity
              ...
              <Text style={[styles.buttonText, activeButton === 'Donations' && styles.activeButtonText]}>Details</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.toggleButton, activeButton === 'Subscribed' && styles.activeButton]}
              onPress={() => setActiveButton('Subscribed')}>
              <Text style={[styles.buttonText, activeButton === 'Subscribed' && styles.activeButtonText]}>Subscribers</Text>
            </TouchableOpacity>
            <TouchableOpacity
      ...
      <View style={[styles.additionalView, { marginTop: 16 }]}>
